...
// For jump icon when release
  ...
  late Animation moveLeftIconLikeWhenRelease, moveLeftIconLoveWhenRelease, moveLeftIconHahaWhenRelease, moveLeftIconWowWhenRelease, moveLeftIconSadWhenRelease, moveLeftIconAngryWhenRelease;
...
// Icons
  ...
  initAnimationIconWhenRelease() {
    ...
    zoomIconWhenRelease = Tween(begin: 1.8, end: 0.0).animate(CurvedAnimation(parent: animControlIconWhenRelease, curve: Curves.decelerate));

    moveUpIconWhenRelease = Tween(begin: 180.0, end: 0.0).animate(CurvedAnimation(parent: animControlIconWhenRelease, curve: Curves.decelerate));

    moveLeftIconLikeWhenRelease = Tween(begin: 20.0, end: 10.0).animate(CurvedAnimation(parent: animControlIconWhenRelease, curve: Curves.decelerate));
    moveLeftIconLoveWhenRelease = Tween(begin: 68.0, end: 10.0).animate(CurvedAnimation(parent: animControlIconWhenRelease, curve: Curves.decelerate));
    moveLeftIconHahaWhenRelease = Tween(begin: 116.0, end: 10.0).animate(CurvedAnimation(parent: animControlIconWhenRelease, curve: Curves.decelerate));
    moveLeftIconWowWhenRelease = Tween(begin: 164.0, end: 10.0).animate(CurvedAnimation(parent: animControlIconWhenRelease, curve: Curves.decelerate));
    moveLeftIconSadWhenRelease = Tween(begin: 212.0, end: 10.0).animate(CurvedAnimation(parent: animControlIconWhenRelease, curve: Curves.decelerate));
    moveLeftIconAngryWhenRelease = Tween(begin: 260.0, end: 10.0).animate(CurvedAnimation(parent: animControlIconWhenRelease, curve: Curves.decelerate));
...
//               : const SizedBox(),
  ...
  Widget renderBox() {
    return Opacity(
      ...
      child: Container(
        ...
        width: 200.0,
        height: zoomBoxWhenDragOutside.value,
  ...
  Widget renderIcons() {
    return Container(
      ...
      height: 70,
      color: Colors.red,
      // margin: const EdgeInsets.only(left: 20.0, bottom: 0, top: 15),
      child: Row(
...
// icon like
          Transform.scale(
            ...
            child: Container(
              ...
              // width: 40.0,
              height: currentIconFocus == 1 ? 35.0 : 20.0,
              child: Column(
                children: <Widget>[
                  // currentIconFocus == 1
                  //     ? Container(
...
// icon love
          Transform.scale(
            ...
            child: Container(
              ...
              height: currentIconFocus == 2 ? 35.0 : 20.0,
              child: Column(
                children: <Widget>[
                  // currentIconFocus == 2
                  //     ? Container(
                  //         decoration: BoxDecoration(borderRadius: BorderRadius.circular(10.0), color: Colors.black.withOpacity(0.3)),
                  //         padding: const EdgeInsets.only(left: 7.0, right: 7.0, top: 2.0, bottom: 2.0),
                  //         margin: const EdgeInsets.only(bottom: 8.0),
                  //         child: Text(
...
// icon haha
          Transform.scale(
            ...
            child: Container(
              ...
              height: currentIconFocus == 3 ? 35.0 : 20.0,
              child: Column(
                children: <Widget>[
                  // currentIconFocus == 3
                  //     ? Container(
...
// icon wow
          Transform.scale(
            ...
            child: Container(
              ...
              height: currentIconFocus == 4 ? 35.0 : 20.0,
              child: Column(
                children: <Widget>[
                  // currentIconFocus == 4
                  //     ? Container(
...
// icon sad
          Transform.scale(
            ...
            child: Container(
              ...
              height: currentIconFocus == 5 ? 35.0 : 20.0,
              child: Column(
                children: <Widget>[
                  // currentIconFocus == 5
                  //     ? Container(
                  ...
                  //         child: Text(
                  //           widget.sadText ?? 'Sad',
                  //           style: const TextStyle(fontSize: 2.0, color: Colors.white),
                  //         ),
                  //       )
                  //     : const SizedBox(),
                  Image.asset(
...
// icon angry
          Transform.scale(
            ...
            child: Container(
              ...
              height: currentIconFocus == 6 ? 35.0 : 20.0,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.end,
                children: <Widget>[
                  // currentIconFocus == 6
...
// Icon like
            Transform.scale(
              scale: !isLongPress ? handleOutputRangeZoomInIconLike(zoomIconLikeInBtn2.value) : zoomIconLikeInBtn.value,
              child: Transform.rotate(
                angle: !isLongPress ? handleOutputRangeTiltIconLike(tiltIconLikeInBtn2.value) : tiltIconLikeInBtn.value,
                child: Image.asset(
                  getImageIconBtn(),
                  width: 25.0,
                  height: 25.0,
...
// Text like
            Transform.scale(
              scale: !isLongPress ? handleOutputRangeZoomInIconLike(zoomIconLikeInBtn2.value) : zoomTextLikeInBtn.value,
              child: Text(
                getTextBtn(),
                style: TextStyle(
